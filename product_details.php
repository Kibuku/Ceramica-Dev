...
<section style='min-height: calc(100vh - 40px);'>
    <nav aria-label="breadcrumb" class="w-100 float-left">
        <ol class="breadcrumb parallax justify-content-center" data-source-url="img/banner/parallax_.jpg" style="background-image: url(&quot;img/banner/parallax_.jpg&quot;); background-position: 50% 49.7062%; background-repeat: no-repeat; background-size: cover; overflow: hidden;  position: relative;">
            ...
            <li class="breadcrumb-item active" style='z-index: 5;' aria-current="page">shop</li>
        </ol>
    </nav>
    <?php 
...
?>
            ...
            <div class="row">
                <div class="left-columm col-lg-6 col-md-6">
                 ...
                 $img= check_image($conn,$product_id,100);
                        ...
                        <div class="single-img img-full">
                            <a href="img/products/<?php echo $row['image_name']; ?>"><img src="img/products/<?php echo $row['image_name']; ?>" class="img-fluid zoomImg" alt=""></a>
                        </div>
                        <?php } } ?>
                        <div class="single-img img-full">
                            <a href="img/products/<?php echo get_product_detail($conn,$product_id,"image_name"); ?>"><img src="img/products/<?php echo get_product_detail($conn,$product_id,"image_name"); ?>" class="img-fluid zoomImg" alt=""></a>
                        </div>
                    </div>
                ...
                <div class="right-columm col-lg-6 col-md-6">
                    <div class="product-information">
                        ...
                        <?php echo get_product_detail($conn,$product_id,"product_name"); ?>
                        </h4>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 size-options d-flex align-items-center">
                                ...
                                <select class="form-control" name="select">
                                    <option value="" selected="">
                                        <?php echo get_check_package($conn,get_product_detail($conn,$product_id,"packaging_id"),"description");  ?></option>
                        ...
                        <div class="price float-left w-100 d-flex">
                            <div class="regular-price">  <?php echo $currency; ?> <?php echo number_format(get_product_detail($conn,$product_id,"amount") * $convert, 2, '.', ','); ?> </div>
                            <div class="old-price"> <?php echo $currency; ?> <?php echo number_format(get_product_detail($conn,$product_id,"amount") * $convert, 2, '.', ','); ?> </div>
                        </div>
                        <div class="product-variants float-left w-100">
                            <div class="col-md-3 col-sm-6 col-xs-12 size-options d-flex align-items-center">
                                <h5>Category: <?php echo check_category($conn,get_product_detail($conn,$product_id,"category_id"),"description"); ?></h5>
                        ...
                        <div class="btn-cart d-flex align-items-center float-left w-100">
                            <h5>qty:</h5>
                            <input name="qty" id="<?php  echo $product_id; ?>" value="1" type="number">
                               
                        
                            <button class='add-to-cart' data-product-id='<?php  echo $product_id; ?>'> <i class="material-icons">shopping_cart</i> 
                                Add To Cart</button>
                        </div>
                    ...
                    <div class="reviews-tab  float-left w-100">
                        <div class="ttreview-tab float-left w-100 p-30">
                            ...
                            <div class="review-desc  float-left w-100">
                                Aliquam at ipsum tellus. Donec arcu est, posuere quis orci vel, commodo cursus augue.
                            </div>
                        </div>
    ...
    <!--            <div class="product-accessories-content products grid owl-carousel owl-loaded owl-drag">-->
    <!--                <div class="owl-stage-outer">-->
    <!--                    <div class="owl-stage" style="transform: translate3d(-1616px, 0px, 0px); transition: all 0.25s ease 0s; width: 3880px;">-->
    <!--                        <div class="owl-item cloned" style="width: 323.333px;">-->
    ...
    <!--                                                <a href="product_details">voluptas nulla pariatur</a>-->
    <!--                                            </h4>-->
    <!--                                        </div>-->
    <!--                                        <div class="rating">-->
    <!--                                            <div class="product-ratings d-inline-block align-middle">-->
    ...
    <!--                                        </div>-->
    <!--                                        <div class="price">-->
    <!--                                            <div class="regular-price">KES 100.00</div>-->
    <!--                                            <div class="old-price">KES 150.00</div>-->
    <!--                                        </div>-->
    ...
    <!--                                                </button>-->
    <!--                                                <a href="wishlist" class="btn btn-primary btn-wishlist">-->
    <!--                                                    <i class="material-icons">favorite</i>-->
    <!--                                                    <span>wishlist</span>-->
    <!--                                                </a>-->
    ...
    <!--                                        <div class="caption">-->
    <!--                                            <h4 class="product-title text-capitalize">-->
    <!--                                                <a href="product_details">aliquam quat voluptatem</a>-->
    <!--                                            </h4>-->
    <!--                                        </div>-->
    <!--                                        <div class="rating">-->
    <!--                                            <div class="product-ratings d-inline-block align-middle">-->
    ...
    <!--                                        <div class="caption">-->
    <!--                                            <h4 class="product-title text-capitalize">-->
    <!--                                                <a href="product_details">voluptas sit aspernatur</a>-->
    <!--                                            </h4>-->
    <!--                                        </div>-->
    <!--                                        <div class="rating">-->
    <!--                                            <div class="product-ratings d-inline-block align-middle">-->
    ...
    <!--                            </div>-->
    <!--                        </div>-->
    <!--                        <div class="owl-item" style="width: 323.333px;">-->
    <!--                            <div class="product-layouts">-->
    <!--                                <div class="product-thumb">-->
    <!--                                    <div class="image zoom">-->
    <!--                                        <a href="product_details">-->
    ...
    <!--                                        <div class="caption">-->
    <!--                                            <h4 class="product-title text-capitalize">-->
    <!--                                                <a href="product_details">aliquam quaerat voluptatem</a>-->
    <!--                                            </h4>-->
    <!--                                        </div>-->
    <!--                                        <div class="rating">-->
    <!--                                            <div class="product-ratings d-inline-block align-middle">-->
    ...
    <!--                                            <img src="img/products/03.jpg" alt="03" class="second_image img-responsive">-->
    <!--                                        </a>-->
    <!--                                    </div>-->
    <!--                                    <div class="thumb-description">-->
    <!--                                        <div class="caption">-->
    ...
    <!--                            </div>-->
    <!--                        </div>-->
    <!--                        <div class="owl-item active" style="width: 323.333px;">-->
    <!--                            <div class="product-layouts">-->
    <!--                                <div class="product-thumb">-->
    <!--                                    <div class="image zoom">-->
    <!--                                        <a href="product_details">-->
