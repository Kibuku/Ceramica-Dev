	...
	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active left-to-right hb-animate-element">
				<div style='height: 100%; width: 100%; z-index: 2; background-color: #080d15; opacity: .4; position: absolute;'></div>
			...
			<div class="carousel-item left-to-right hb-animate-element">
				<div style='height: 100%; width: 100%; z-index: 2; background-color: #080d15; opacity: .3; position: absolute;'></div>
			...
			<div class="carousel-item left-to-right hb-animate-element">
				<div style='height: 100%; width: 100%; z-index: 2; background-color: #080d15; opacity: .2; position: absolute;'></div>
					...
					<div class="row">
						...
						<div class="tabs">
							<ul class="nav nav-tabs justify-content-center">
								<li class="nav-item">
									<a class="nav-link active" data-toggle="tab" href="#ttfeatured-main" id="featured-tab">
										<div class="tab-title">Featured</div>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#ttnew-main" id="new-tab">
										<div class="tab-title">Latest</div>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#ttbestseller-main" id="bestseller-tab">
						...
						<div class="tab-content float-left w-100">
													...
													<div class="product-layouts">
														<div class="product-thumb">
															<div class="image zoom">
																<a href="product_details?product_id=<?php echo $row_p['product_id']; ?>">
																	<img src="img/products/<?php echo check_image($conn,$row_p['product_id'],1); ?>" alt="05" style="height: 350px; object-fit: cover;" width="385">
																	<img src="img/products/<?php echo check_image($conn,$row_p['product_id'],1); ?>" alt="05" class="second_image img-responsive" style="height: 350px; object-fit: cover;" width="385"></a>
															</div>
															<div class="thumb-description">
																<div class="caption">
																	<h4 class="product-title text-capitalize"><a href="product_details"><?php echo $row_p['product_name']; ?></a></h4>
																</div>
																<div class="rating">
																...
																<div class="price">
																	<div class="regular-price"><?php echo $currency; ?> <?php echo number_format($row_p['amount'] * $convert, 2, '.', ','); ?></div>
																	<div class="old-price"><?php echo $currency; ?> <?php echo number_format($row_p['amount'] * $convert, 2, '.', ','); ?></div>
																</div>
																<div class="button-wrapper">
																	<div class="button-group text-center">
																		...
																		<a type="button" class="btn btn-primary btn-quickview" href='product_details?product_id=<?php echo $row_p['product_id']; ?>' ><i class="material-icons">visibility</i><span>Quick View</span></a>
																	</div>
																</div>
															</div>
														</div>
							...
							<!--							<img src="img/products/01.jpg" alt="01" class="second_image img-responsive" style="height: 350px; object-fit: cover;" width="385"> -->
							<!--						</a>													-->
							<!--					</div>-->
							<!--					<div class="thumb-description">-->
							<!--						<div class="caption">-->
