...
<head>
    ...
    <meta name="description" content="Tridenn Ceramics">
                    ...
                    <div class="container">
                        <div class="header-left float-left d-flex d-lg-flex d-md-block d-xs-block">
                            <div class="contact" style='white-space: nowrap; font-size: smaller;'>
                                ...
                                <a href="https://www.instagram.com/tridenn_ceramics/" class='ig'>
                        ...
                        <div class="header-middle float-lg-left float-md-left float-sm-left float-xs-none">
                            <div class="logo">
                                <a href="index">
                                    <img src="img/logos/logo.png" alt="logo" style="height: 40px">
                                </a>
                            </div>
                        </div>
