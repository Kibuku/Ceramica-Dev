...
<div class="block-newsletter">
	<div class="parallax" data-source-url="img/banner/parallax.jpg" style="background-image:url(img/banner/parallax.jpg); background-position:50% 65.8718%; background-repeat: no-repeat; background-size: cover;  position: relative;">
		<div style='height: 100%; width: 100%; z-index: 2; background-color: #080d15; opacity: .7; position: absolute; top: 0;'></div>
		<div class="container">
			<div class="tt-newsletter col-sm-7" style='z-index: 5;'>
				<h2 class="text-uppercase">Subscribe to our Newsletter</h2>
			</div>
			<div class="block-content col-sm-5" style='z-index: 5;'>
...
<footer class="page-footer font-small footer-default">
	<div class="container text-center text-md-left">
		<div class="row">
			<div class="col-md-2 footer-cms footer-column">
				<div class="ttcmsfooter">
					<div class="footer-logo">
						<img src="img/logos/footer-logo.png" alt="footer-logo" width="200" style='height: 10vh; object-fit: contain;'>
					</div>
			...
			<div class="col-md-2 footer-column">
				<div class="title">
					<a href="#shop" class="font-weight-normal text-capitalize mb-10" data-toggle="collapse" aria-expanded="false">Shop</a>
				</div>
			...
			<div class="col-md-2 footer-column">
				<div class="title">
					<a href="#classes" class="font-weight-normal text-capitalize mb-10" data-toggle="collapse" aria-expanded="false">Classes</a>
				</div>
				<ul id="classes" class="list-unstyled collapse">
					<li>
						<a href="ongoing_class">Ongoing pottery classes</a>
					</li>
					<li>
						<a href="book_lession">Book a lession</a>
					</li>
				</ul>
			</div>
			<div class="col-md-2 footer-column">
				<div class="title">
					<a href="#links" class="font-weight-normal text-capitalize mb-10" data-toggle="collapse" aria-expanded="false">Quick Links</a>
				</div>
				...
				<ul id="information" class="list-unstyled collapse">
					<li class="contact-detail links">
						<span class="address">
							...
							<span class="data"> Tridenn Ceramics LTD Ngong Racecourse, Nairobi, Kenya.</span>
						</span>
					</li>
					<li class="links">
						<span class="contact">
	...
	<!-- Copyright -->
	<div class="footer-bottom-wrap" style='background: #a39382; color: #fff;'>
		<div class="container">
			<div class="row">
				<div class="footer-copyright text-center py-3 text-white h6">
					<b>Tridenn Ceramics © 2023</b>
				</div>
			</div>
		</div>
	</div>
	<a href="#" id="goToTop" title="Back to top" class="btn-primary">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6 left-columm">
						...
						<div class="small-image-list float-left w-100">
							<div class="nav-add small-image-slider-single-product-tabstyle-3 owl-carousel owl-loaded owl-drag" role="tablist">
								...
								<div class="owl-nav"><button type="button" role="presentation" class="owl-prev disabled"><i class="material-icons"></i></button><button type="button" role="presentation" class="owl-next"><i class="material-icons"></i></button></div>
					...
					<div class="col-md-6 product_content">
						...
						<h3 class="price float-left w-100"><span class="regular-price align-middle">KES 75.00</span><span class="old-price align-middle">KES 60.00</span></h3>
			...
			<div class="modal-body">
				<div class="row">
						...
						<p class="total-products float-left w-100">
							<strong>Total products:</strong> KES 150.00
						</p>
						<p class="shipping float-left w-100">
							<strong>Total shipping:</strong> free
						</p>
						<p class="total-price float-left w-100">
							<strong>Total:</strong> KES 150.00(tax incl.)
						</p>
						<div class="cart-content-btn float-left w-100">
							<a href="" class="btn pull-right mt_10 btn-primary mr-1 ml-1">Continue shopping</a>
							<a href="checkout_page" class="btn pull-right mt_10 btn-secondary mr-1 ml-1">Proceed to checkout</a>
	...
	<div class="compare-inner d-flex align-items-center p-20">
		...
		<div class="col-xs-12 col-sm-10 col-md-9 d-flex float-left align-items-center compare-right">
			...
			<div class="buttons col-sm-5 col-lg-2">
				<a href="compare" class="compare-btn btn btn-secondary float-left w-100 mb-15">compare</a>
...
<script src="js/jquery.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/bootstrap.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/owl.carousel.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/custom.js?ver=<?php echo date('his');?>"></script>
<script src="js/parallax.js?ver=<?php echo date('his');?>"></script>
<script src="js/lightbox-2.6.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/ResizeSensor.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/theia-sticky-sidebar.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/inview.js?ver=<?php echo date('his');?>"></script>
<script src="js/cookiealert.js?ver=<?php echo date('his');?>"></script>
<script src="js/jquery.countdown.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/masonry.pkgd.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/imagesloaded.pkgd.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/jquery.zoom.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/jquery.lazy.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/slick.min.js?ver=<?php echo date('his');?>"></script>
<script src="js/loader.js?ver=<?php echo date('his');?>"></script>
<script src="js/shipping_select.js?ver=<?php echo date('his');?>"></script>
<script src="js/cart_calc.js?ver=<?php echo date('his');?>"></script>
<script src="js/calendar.js?ver=<?php echo date('his');?>"></script>
...
<noscript>
	<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id={3156992947902949}&ev=PageView&noscript=1" />
</noscript>
